      ...
      <Container className='story-container'>
        ...
        <Row>
          ...
          <Col md={8} className='text-left mt-3'>
            ...
            <p>
              &ensp; It's for this reason that we not only love what we do, but
              do it with so much love. We realize and cherish that in designing,
            ...
            <p>
              ...
              families around a meal at a table, and inspire them to play games,
              share laughs & create moments of meaningful conversation the same
              way our business was founded, at the Dinner Table. ​
            </p>
            <p>
            ...
            <p>
              ...
              place for life long memories to be made, and the story of our
              lives to be shared.
            </p>
          </Col>{' '}
          <Col md={2} />
